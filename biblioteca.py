...
from tkinter import simpledialog, messagebox, Frame, Button, Label, Entry, Toplevel, Listbox
...
class LibraryGUI:
    def __init__(self, master):
        ...
        self.master.geometry("1200x900")  # Aumente o tamanho da janela aqui
    ...
    def center_window(self):
        ...
        x = int((screen_width / 2) - (1200 / 2))  # Altere aqui para centralizar a janela maior
        y = int((screen_height / 2) - (900 / 2))  # Altere aqui para centralizar a janela maior
        self.master.geometry(f'1200x900+{x}+{y}')  # Ajuste para o novo tamanho
